...
greeting_label = tk.Label(frame, text="Hi! How can I help you?", font=("Helvetica", 14, "bold"), bg="#e6f7ff")
...
password_label = tk.Label(password_frame, text="Your Password:", bg="#e6f7ff")
password_label.pack()
...
thank_you_label = tk.Label(root, text="Thank you for using our Password Generator!", font=("Helvetica", 10), bg="#e6f7ff")
